...
class UserForm extends Component {
  ...
  handleChange = event => {
    const { name, value, checked, type } = event.target; // диструктурируем значения

    const val = type === 'checkbox' //если тип елемента checkbox присваиваем checked если нет тогда  value 
      ? checked
      : value;
    ...
    return (
      <form className="login-form">
        ...
        <div className="form-control">
          ...
          <input className="form-input" value={this.state.name} type="text" id="name" name="name" value="" onChange={this.handleChange} />
        </div>
        <div className="form-control">
        ...
        <div className="form-control">
          ...
          <textarea name="about" value={this.state.about} className="form-input" onChange={this.handleChange}></textarea>
        </div>
